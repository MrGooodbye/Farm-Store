...
<?php 
          ...
          {
            $total_dangco_KM = $giaKM * $result['quantity'];
            echo '<p>'.$fm->format_currency($total_dangco_KM).'</p>';
          }
?>
          </div>
...
<?php 
          $subtotal += $total + $total_dangco_KM;
      }
...
?>  
  ...
  <form action ="momo_createpayment.php" method = "post">
                    ...
                    <button type="submit" class='btn btn-thanhtoan' name ='redirect'>Thanh Toán MOMO</button>
                </form>
